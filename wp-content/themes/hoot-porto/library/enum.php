...
function hoot_enum_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'hoot-porto' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'hoot-porto' ),
		'repeat-y'  => __( 'Repeat Vertically', 'hoot-porto' ),
		'repeat'    => __( 'Repeat All', 'hoot-porto' ),
		);
...
function hoot_enum_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'hoot-porto' ),
		'top center'    => __( 'Top Center', 'hoot-porto' ),
		'top right'     => __( 'Top Right', 'hoot-porto' ),
		'center left'   => __( 'Middle Left', 'hoot-porto' ),
		'center center' => __( 'Middle Center', 'hoot-porto' ),
		'center right'  => __( 'Middle Right', 'hoot-porto' ),
		'bottom left'   => __( 'Bottom Left', 'hoot-porto' ),
		'bottom center' => __( 'Bottom Center', 'hoot-porto' ),
		'bottom right'  => __( 'Bottom Right', 'hoot-porto')
		);
...
function hoot_enum_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'hoot-porto' ),
		'fixed'  => __( 'Fixed in Place', 'hoot-porto'),
		);
...
function hoot_enum_background_size() {
	$default = array(
		'original' => __( 'Original Size', 'hoot-porto' ),
		'contain'  => __( 'Fit to Screen', 'hoot-porto'),
		'cover'    => __( 'Fill Screen', 'hoot-porto'),
		);
...
function hoot_enum_background_type() {
	$default = array(
		'predefined' => __( 'Predefined Pattern', 'hoot-porto' ),
		'custom'     => __( 'Custom Image', 'hoot-porto' ),
		);
...
function hoot_enum_font_styles() {
	$default = array(
		'none'                      => __( 'None', 'hoot-porto' ),
		'italic'                    => __( 'Italic', 'hoot-porto' ),
		'bold'                      => __( 'Bold', 'hoot-porto' ),
		'bold italic'               => __( 'Bold Italic', 'hoot-porto' ),
		'semibold'                  => __( 'SemiBold', 'hoot-porto' ),
		'semibold italic'           => __( 'SemiBold Italic', 'hoot-porto' ),
		'lighter'                   => __( 'Light', 'hoot-porto' ),
		'lighter italic'            => __( 'Light Italic', 'hoot-porto' ),
		'uppercase'                 => __( 'Uppercase', 'hoot-porto' ),
		'uppercase italic'          => __( 'Uppercase Italic', 'hoot-porto' ),
		'uppercase bold'            => __( 'Uppercase Bold', 'hoot-porto' ),
		'uppercase bold italic'     => __( 'Uppercase Bold Italic', 'hoot-porto' ),
		'uppercase semibold'        => __( 'Uppercase SemiBold', 'hoot-porto' ),
		'uppercase semibold italic' => __( 'Uppercase SemiBold Italic', 'hoot-porto' ),
		'uppercase lighter'         => __( 'Uppercase Light', 'hoot-porto' ),
		'uppercase lighter italic'  => __( 'Uppercase Light Italic', 'hoot-porto' )
		);
...
function hoot_enum_social_profiles( $skype = false, $email = true ) {
	$social = array(
		'fa-amazon'         => __( 'Amazon', 'hoot-porto' ),
		'fa-android'        => __( 'Android', 'hoot-porto' ),
		'fa-apple'          => __( 'Apple', 'hoot-porto' ),
		'fa-bandcamp'       => __( 'Bandcamp', 'hoot-porto' ),
		'fa-behance'        => __( 'Behance', 'hoot-porto' ),
		'fa-bitbucket'      => __( 'Bitbucket', 'hoot-porto' ),
		'fa-btc'            => __( 'BTC', 'hoot-porto' ),
		'fa-buysellads'     => __( 'BuySellAds', 'hoot-porto' ),
		'fa-codepen'        => __( 'Codepen', 'hoot-porto' ),
		'fa-codiepie'       => __( 'Codie Pie', 'hoot-porto' ),
		'fa-contao'         => __( 'Contao', 'hoot-porto' ),
		'fa-dashcube'       => __( 'Dash Cube', 'hoot-porto' ),
		'fa-delicious'      => __( 'Delicious', 'hoot-porto' ),
		'fa-deviantart'     => __( 'Deviantart', 'hoot-porto' ),
		'fa-digg'           => __( 'Digg', 'hoot-porto' ),
		'fa-discord'        => __( 'Discord', 'hoot-porto' ),
		'fa-dribbble'       => __( 'Dribbble', 'hoot-porto' ),
		'fa-dropbox'        => __( 'Dropbox', 'hoot-porto' ),
		'fa-eercast'        => __( 'Eercast', 'hoot-porto' ),
		'fa-envelope'       => __( 'Email', 'hoot-porto' ),
		'fa-etsy'           => __( 'Etsy', 'hoot-porto' ),
		'fa-facebook'       => __( 'Facebook', 'hoot-porto' ),
		'fa-flickr'         => __( 'Flickr', 'hoot-porto' ),
		'fa-forumbee'       => __( 'Forumbee', 'hoot-porto' ),
		'fa-foursquare'     => __( 'Foursquare', 'hoot-porto' ),
		'fa-free-code-camp' => __( 'Free Code Camp', 'hoot-porto' ),
		'fa-get-pocket'     => __( 'Pocket (getpocket)', 'hoot-porto' ),
		'fa-github'         => __( 'Github', 'hoot-porto' ),
		'fa-google'         => __( 'Google', 'hoot-porto' ),
		'fa-google-plus'    => __( 'Google Plus', 'hoot-porto' ),
		'fa-google-wallet'  => __( 'Google Wallet', 'hoot-porto' ),
		'fa-houzz'          => __( 'Houzz', 'hoot-porto' ),
		'fa-imdb'           => __( 'IMDB', 'hoot-porto' ),
		'fa-instagram'      => __( 'Instagram', 'hoot-porto' ),
		'fa-jsfiddle'       => __( 'JS Fiddle', 'hoot-porto' ),
		'fa-lastfm'         => __( 'Last FM', 'hoot-porto' ),
		'fa-leanpub'        => __( 'Leanpub', 'hoot-porto' ),
		'fa-linkedin'       => __( 'Linkedin', 'hoot-porto' ),
		'fa-meetup'         => __( 'Meetup', 'hoot-porto' ),
		'fa-mixcloud'       => __( 'Mixcloud', 'hoot-porto' ),
		'fa-patreon'        => __( 'Patreon', 'hoot-porto' ),
		'fa-paypal'         => __( 'Paypal', 'hoot-porto' ),
		'fa-pinterest'      => __( 'Pinterest', 'hoot-porto' ),
		'fa-quora'          => __( 'Quora', 'hoot-porto' ),
		'fa-reddit'         => __( 'Reddit', 'hoot-porto' ),
		'fa-rss'            => __( 'RSS', 'hoot-porto' ),
		'fa-scribd'         => __( 'Scribd', 'hoot-porto' ),
		'fa-skype'          => __( 'Skype', 'hoot-porto' ),
		'fa-slack'          => __( 'Slack', 'hoot-porto' ),
		'fa-slideshare'     => __( 'Slideshare', 'hoot-porto' ),
		'fa-snapchat'       => __( 'Snapchat', 'hoot-porto' ),
		'fa-soundcloud'     => __( 'Soundcloud', 'hoot-porto' ),
		'fa-spotify'        => __( 'Spotify', 'hoot-porto' ),
		'fa-stack-exchange' => __( 'Stack Exchange', 'hoot-porto' ),
		'fa-stack-overflow' => __( 'Stack Overflow', 'hoot-porto' ),
		'fa-steam'          => __( 'Steam', 'hoot-porto' ),
		'fa-stumbleupon'    => __( 'Stumbleupon', 'hoot-porto' ),
		'fa-tiktok'         => __( 'TikTok', 'hoot-porto' ),
		'fa-trello'         => __( 'Trello', 'hoot-porto' ),
		'fa-telegram-plane' => __( 'Telegram', 'hoot-porto' ),
		'fa-tripadvisor'    => __( 'Trip Advisor', 'hoot-porto' ),
		'fa-tumblr'         => __( 'Tumblr', 'hoot-porto' ),
		'fa-twitch'         => __( 'Twitch', 'hoot-porto' ),
		'fa-twitter'        => __( 'Twitter', 'hoot-porto' ),
		'fa-viadeo'         => __( 'Viadeo', 'hoot-porto' ),
		'fa-vimeo-square'   => __( 'Vimeo', 'hoot-porto' ),
		'fa-vk'             => __( 'VK', 'hoot-porto' ),
		'fa-whatsapp'       => __( 'Whatsapp', 'hoot-porto' ),
		'fa-wikipedia-w'    => __( 'Wikipedia', 'hoot-porto' ),
		'fa-windows'        => __( 'Windows', 'hoot-porto' ),
		'fa-wordpress'      => __( 'WordPress', 'hoot-porto' ),
		'fa-x-twitter'      => __( 'X (Twitter)', 'hoot-porto' ),
		'fa-square-x-twitter' => __( 'X (Twitter) Square', 'hoot-porto' ),
		'fa-xing'           => __( 'Xing', 'hoot-porto' ),
		'fa-y-combinator'   => __( 'Y Combinator', 'hoot-porto' ),
		'fa-yelp'           => __( 'Yelp', 'hoot-porto' ),
		'fa-youtube'        => __( 'Youtube', 'hoot-porto' ),
	);
...
function hoot_fonticons_list( $return = 'icons' ) {
	...
	if ( 'sections' == $return ) :
		return apply_filters( 'hoot_fonticons_sections', array(
			'fonticons' => __('Font Icons', 'hoot-porto'),
			'brands'    => __('Brands', 'hoot-porto'),
			)
		);
	endif;
