...
<div class="wp-block-columns" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:column {"verticalAlignment":"center","width":"20%","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0"}}},"className":"banner-category-column"} -->
...
<!-- wp:woocommerce/product-categories {"hasCount":false,"style":{"color":{"text":"#4c4c4c"},"elements":{"link":{"color":{"text":"#4c4c4c"}}}},"className":"banner-product-category"} /--></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"top","width":"80%"} -->
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:80%"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/banner.png'); ?>","id":29,"dimRatio":0,"minHeight":600,"minHeightUnit":"px","isDark":false,"align":"wide","className":"banner-image-cover","layout":{"type":"constrained"}} -->
...
<div class="wp-block-columns are-vertically-aligned-center" style="margin-top:0;margin-bottom:0"><!-- wp:column {"verticalAlignment":"center","width":"40%","className":"banner-text"} -->
<div class="wp-block-column is-vertically-aligned-center banner-text" style="flex-basis:40%"><!-- wp:heading {"textAlign":"left","level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"typography":{"fontSize":"26px","fontStyle":"normal","fontWeight":"700"},"spacing":{"padding":{"left":"0"}}},"textColor":"white"} -->
