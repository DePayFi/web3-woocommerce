...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"backgroundColor":"white","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
<div class="wp-block-group has-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:image {"id":14,"sizeSlug":"full","linkDestination":"none"} -->
...
<div class="wp-block-group upper-header has-background" style="background-color:#cce3e2;padding-top:0px;padding-right:20px;padding-bottom:0px;padding-left:20px"><!-- wp:columns {"verticalAlignment":null,"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-center header-nav" style="flex-basis:5%"><!-- wp:navigation {"textColor":"heading","overlayMenu":"always","overlayBackgroundColor":"white","customOverlayTextColor":"#0b4d4a","layout":{"type":"flex","flexWrap":"wrap"},"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontFamily":"merriweather"} /-->
</div>
<!-- /wp:column -->
