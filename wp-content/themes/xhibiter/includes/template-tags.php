						...
						<?php if ( $socials['facebook'] || $socials['twitter'] || $socials['linkedin'] || $socials['instagram'] || $socials['youtube'] || $socials['vimeo'] || $socials['discord'] || $socials['github'] ) : ?>
							...
							<div class="entry-author__socials socials socials--no-base">
								...
								<?php if ( $socials['facebook'] ) : ?>
									<a href="<?php echo esc_url( the_author_meta( $socials['facebook'] ) ); ?>" class="social social-facebook group" title="<?php echo esc_attr( $socials['facebook'] ); ?>" rel="noopener nofollow" target="_blank" aria-label="<?php echo esc_attr__( 'Author\'s Facebook (opens in new window)', 'xhibiter' ); ?>">
								...
								<?php if ( $socials['twitter'] ) : ?>
									<a href="<?php echo esc_url( the_author_meta( $socials['twitter'] ) ); ?>" class="social social-twitter group" title="<?php echo esc_attr( $socials['twitter'] ); ?>" rel="noopener nofollow" target="_blank" aria-label="<?php echo esc_attr__( 'Author\'s Twitter (opens in new window)', 'xhibiter' ); ?>">
								...
								<?php if ( $socials['linkedin'] ) : ?>
									<a href="<?php echo esc_url( the_author_meta( $socials['linkedin'] ) ); ?>" class="social social-linkedin group" title="<?php echo esc_attr( $socials['linkedin'] ); ?>" rel="noopener nofollow" target="_blank" aria-label="<?php echo esc_attr__( 'Author\'s LinkedIn (opens in new window)', 'xhibiter' ); ?>">
								...
								<?php if ( $socials['instagram'] ) : ?>
									<a href="<?php echo esc_url( the_author_meta( $socials['instagram'] ) ); ?>" class="social social-instagram group" title="<?php echo esc_attr( $socials['instagram'] ); ?>" rel="noopener nofollow" target="_blank" aria-label="<?php echo esc_attr__( 'Author\'s Instagram (opens in new window)', 'xhibiter' ); ?>">
								...
								<?php if ( $socials['youtube'] ) : ?>
									<a href="<?php echo esc_url( the_author_meta( $socials['youtube'] ) ); ?>" class="social social-youtube group" title="<?php echo esc_attr( $socials['youtube'] ); ?>" rel="noopener nofollow" target="_blank" aria-label="<?php echo esc_attr__( 'Author\' YouTube (opens in new window)', 'xhibiter' ); ?>">
								...
								<?php if ( $socials['vimeo'] ) : ?>
									<a href="<?php echo esc_url( the_author_meta( $socials['vimeo'] ) ); ?>" class="social social-vimeo group" title="<?php echo esc_attr( $socials['vimeo'] ); ?>" rel="noopener nofollow" target="_blank" aria-label="<?php echo esc_attr__( 'Author\'s Vimeo (opens in new window)', 'xhibiter' ); ?>">
								...
								<?php if ( $socials['discord'] ) : ?>
									<a href="<?php echo esc_url( the_author_meta( $socials['discord'] ) ); ?>" class="social social-discord group" title="<?php echo esc_attr( $socials['github'] ); ?>" rel="noopener nofollow" target="_blank" aria-label="<?php echo esc_attr__( 'Author\'s Discord (opens in new window)', 'xhibiter' ); ?>">
								...
								<?php if ( $socials['github'] ) : ?>
									<a href="<?php echo esc_url( the_author_meta( $socials['github'] ) ); ?>" class="social social-github group" title="<?php echo esc_attr( $socials['github'] ); ?>" rel="noopener nofollow" target="_blank" aria-label="<?php echo esc_attr__( 'Author\'s Github (opens in new window)', 'xhibiter' ); ?>">
